...
func TestAddRemovePropertyTypeValue(t *testing.T) {
	...
	mr := r.Mutation()
	id1, id2, projectType, propertyType := AddPropertyTypeValueTest(ctx, t, mr)
...
func AddPropertyTypeValueTest(ctx context.Context, t *testing.T, mr generated.MutationResolver) (int, int, int, int) {
