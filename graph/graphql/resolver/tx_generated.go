...
func (tr txResolver) AddSubflowBlock(ctx context.Context, input models.AddSubflowBlockInput) (*ent.Block, error) {
	var result, zero *ent.Block
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
		result, err = mr.AddSubflowBlock(ctx, input)
		return
	}); err != nil {
		return zero, err
	}
...
func (tr txResolver) AddTriggerBlock(ctx context.Context, input models.AddTriggerBlockInput) (*ent.Block, error) {
	var result, zero *ent.Block
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
		result, err = mr.AddTriggerBlock(ctx, input)
		return
	}); err != nil {
		return zero, err
	}
...
func (tr txResolver) AddActionBlock(ctx context.Context, input models.AddActionBlockInput) (*ent.Block, error) {
	var result, zero *ent.Block
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
		result, err = mr.AddActionBlock(ctx, input)
		return
	}); err != nil {
		return zero, err
	}
...
func (tr txResolver) AddConnector(ctx context.Context, input models.ConnectorInput) (*models.ConnectorResult, error) {
	var result, zero *models.ConnectorResult
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
...
func (tr txResolver) DeleteConnector(ctx context.Context, input models.ConnectorInput) (*models.ConnectorResult, error) {
	var result, zero *models.ConnectorResult
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
...
func (tr txResolver) PublishFlow(ctx context.Context, input models.PublishFlowInput) (*ent.Flow, error) {
	var result, zero *ent.Flow
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
		result, err = mr.PublishFlow(ctx, input)
		return
	}); err != nil {
		return zero, err
	}
...
func (tr txResolver) StartFlow(ctx context.Context, input models.StartFlowInput) (*ent.FlowInstance, error) {
	var result, zero *ent.FlowInstance
	if err := tr.WithTransaction(ctx, func(ctx context.Context, mr generated.MutationResolver) (err error) {
		result, err = mr.StartFlow(ctx, input)
		return
	}); err != nil {
		return zero, err
	}
