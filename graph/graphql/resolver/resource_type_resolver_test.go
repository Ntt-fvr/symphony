...
func CreateResourceTypes(ctx context.Context, t *testing.T, mr generated.MutationResolver) (int, int) {
	...
	return resourceType_1.ID, resourceType_2.ID
...
func TestEditResouceType(t *testing.T) {
	...
	resourceType_1, resourceType_2 := CreateResourceTypes(ctx, t, mr)
