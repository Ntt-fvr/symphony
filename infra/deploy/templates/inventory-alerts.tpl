...
%{ for items in [["warning", "1"], ["critical", "5"]] ~}
    - alert: InventoryServiceHTTPErrorsHigh
      annotations:
...
%{ for items in [["warning", "0.5"], ["critical", "1"]] ~}
    - alert: InventoryServiceHTTPLatencyHigh
      annotations:
      ...
      labels:
        severity: ${items[0]}
%{ endfor ~}
    - alert: InventoryServiceSQLErrorsHigh
      annotations:
      ...
      labels:
        severity: critical
    - alert: InventoryServiceNearFDLimit
      annotations:
      ...
      labels:
        severity: warning
    - alert: InventoryServicePodRestart
      annotations:
    ...
    - alert: InventoryNoUpdate
      ...
      labels:
        severity: warning
    - alert: InventoryClientFatalError
      annotations:
