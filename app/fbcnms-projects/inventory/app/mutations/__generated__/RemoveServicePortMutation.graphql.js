...
export type RemoveServicePortMutationVariables = {|
  id: string,
  portId: string,
|};
export type RemoveServicePortMutationResponse = {|
  +removeServicePort: {|
...
export type RemoveServicePortMutation = {|
  ...
  response: RemoveServicePortMutationResponse,
|};
*/


/*
mutation RemoveServicePortMutation(
  $id: ID!
  $portId: ID!
) {
...
return {
  ...
  "params": {
    "cacheID": "02910f25fd53bba85046f4ddc2dd4e82",
    "id": null,
    "metadata": {},
    "name": "RemoveServicePortMutation",
