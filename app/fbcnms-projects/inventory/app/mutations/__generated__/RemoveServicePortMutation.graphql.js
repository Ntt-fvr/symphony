/**
 * @generated SignedSource<<8089602936b24772c9e35dc123a59f9d>>
 * @flow
...
export type RemoveServicePortMutation$variables = {|
  id: string,
  portId: string,
|};
export type RemoveServicePortMutationVariables = RemoveServicePortMutation$variables;
export type RemoveServicePortMutation$data = {|
  +removeServicePort: {|
    +$fragmentSpreads: ServiceCard_service$fragmentType,
  |},
|};
export type RemoveServicePortMutationResponse = RemoveServicePortMutation$data;
export type RemoveServicePortMutation = {|
  variables: RemoveServicePortMutationVariables,
  response: RemoveServicePortMutation$data,
|};
*/
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "RemoveServicePortMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
