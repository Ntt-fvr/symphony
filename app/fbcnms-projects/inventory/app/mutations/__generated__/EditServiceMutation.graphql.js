/**
 * @generated SignedSource<<52c4c7925bd6da828c95258378952ba5>>
 * @flow
...
|};
export type EditServiceMutation$variables = {|
  data: ServiceEditData,
|};
export type EditServiceMutationVariables = EditServiceMutation$variables;
export type EditServiceMutation$data = {|
  +editService: {|
    +$fragmentSpreads: ServiceCard_service$fragmentType,
  |},
|};
export type EditServiceMutationResponse = EditServiceMutation$data;
export type EditServiceMutation = {|
  variables: EditServiceMutationVariables,
  response: EditServiceMutation$data,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "97aa55bbe687a9a14a8e118492bcbb1d",
    "id": null,
    "metadata": {},
    "name": "EditServiceMutation",
...
module.exports = ((node/*: any*/)/*: Mutation<
  EditServiceMutation$variables,
  EditServiceMutation$data,
>*/);
