...
defaultProperties.attrs.label.text = `${fbt('Go to', '')}`;
...
const GoToBaseClass = jointJS.dia.Element.define(
  TYPE,
  defaultProperties,
  markup,
);

export default class GoTo extends GoToBaseClass implements IVertexModel {
...
export function isGoTo(element: ?IVertexModel): boolean {
  if (element == null) {
    return false;
  }
