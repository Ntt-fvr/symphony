...
const HORIZONTAL_PORT_LEFT_ALIN = -42;
const HORIZONTAL_PORT_RIGHT_ALIN = -407;

const TOTAL_SIZE = 72;
const PADDING = 5;
const BORDER = 4;
const BORDER_RADIUS = 16;
const BODY_COORDINATES_REFX2 = -40;
...
const IMAGE_COORDINATES_REFX2 = -45;
...
const LABEL_COORDINATES_REFX2 = -7;
...
const BACKGROUND_COORDINATES_REFX2 = -47;
...
const defaultProperties = {
  attrs: {
    ...
    image: {
      ...VERTEX_COMMON_DISPLAY.defaultAttrProps,
      xlinkHref: '/inventory/static/svg/BlockParallel.svg',
      width: IMAGE_SIZE,
      height: IMAGE_SIZE,
      x: IMAGE_PADDING,
      y: IMAGE_PADDING,
...
defaultProperties.attrs.label.text = `${fbt('Parallel', '')}`;
...
const ParallelBaseClass = jointJS.dia.Element.define(
  TYPE,
  defaultProperties,
  markup,
);
...
export function isParallel(element: ?IVertexModel): boolean {
  if (element == null) {
    return false;
  }
