/**
 * @generated SignedSource<<3ca4aca4786786415e81be765667fc97>>
 * @flow
...
export type PropertyTypeInput = {|
  ...
  isListable?: ?boolean,
|};
export type UserSearchContextQuery$variables = {|
  filters: $ReadOnlyArray<UserFilterInput>,
|};
export type UserSearchContextQueryVariables = UserSearchContextQuery$variables;
export type UserSearchContextQuery$data = {|
  +users: ?{|
    +edges: $ReadOnlyArray<{|
      +node: ?{|
        +id: string,
  ...
  |},
|};
export type UserSearchContextQueryResponse = UserSearchContextQuery$data;
export type UserSearchContextQuery = {|
  variables: UserSearchContextQueryVariables,
  response: UserSearchContextQuery$data,
|};
*/
...
module.exports = ((node/*: any*/)/*: Query<
  UserSearchContextQuery$variables,
  UserSearchContextQuery$data,
>*/);
