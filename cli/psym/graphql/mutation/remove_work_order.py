...
class RemoveWorkOrderMutation:
    @dataclass(frozen=True)
    class RemoveWorkOrderMutationData(DataClassJsonMixin):
        removeWorkOrder: str
    ...
    def execute(cls, client: Client, id: str) -> str:
        ...
        res = cls.RemoveWorkOrderMutationData.from_dict(response_text)
        return res.removeWorkOrder
