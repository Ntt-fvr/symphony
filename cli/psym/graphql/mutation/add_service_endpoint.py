...
from ..input.add_service_endpoint_input import AddServiceEndpointInput
...
class AddServiceEndpointMutation:
    ...
    # fmt: off
    @classmethod
    def execute(cls, client: Client, input: AddServiceEndpointInput) -> AddServiceEndpointMutationData.Service:
        variables: Dict[str, Any] = {"input": input}
        new_variables = encode_variables(variables)
        response_text = client.execute(
            gql("".join(set(QUERY))), variable_values=new_variables
        )
        res = cls.AddServiceEndpointMutationData.from_dict(response_text)
        return res.addServiceEndpoint

    # fmt: off
    @classmethod
    async def execute_async(cls, client: Client, input: AddServiceEndpointInput) -> AddServiceEndpointMutationData.Service:
        variables: Dict[str, Any] = {"input": input}
        new_variables = encode_variables(variables)
