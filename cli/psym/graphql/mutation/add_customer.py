...
class AddCustomerMutation:
    ...
    # fmt: off
    @classmethod
    def execute(cls, client: Client, input: AddCustomerInput) -> AddCustomerMutationData.Customer:
    ...
    # fmt: off
    @classmethod
    async def execute_async(cls, client: Client, input: AddCustomerInput) -> AddCustomerMutationData.Customer:
        variables: Dict[str, Any] = {"input": input}
        new_variables = encode_variables(variables, custom_scalars)
