...
class EditWorkOrderMutation:
    ...
    # fmt: off
    @classmethod
    def execute(cls, client: Client, input: EditWorkOrderInput) -> EditWorkOrderMutationData.WorkOrder:
    ...
    # fmt: off
    @classmethod
    async def execute_async(cls, client: Client, input: EditWorkOrderInput) -> EditWorkOrderMutationData.WorkOrder:
        variables: Dict[str, Any] = {"input": input}
        new_variables = encode_variables(variables, custom_scalars)
