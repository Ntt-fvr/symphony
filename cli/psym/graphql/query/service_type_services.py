...
class ServiceTypeServicesQuery:
    ...
    # fmt: off
    @classmethod
    def execute(cls, client: Client, id: str) -> Optional[ServiceTypeServicesQueryData.Node]:
    ...
    # fmt: off
    @classmethod
    async def execute_async(cls, client: Client, id: str) -> Optional[ServiceTypeServicesQueryData.Node]:
        variables: Dict[str, Any] = {"id": id}
        new_variables = encode_variables(variables)
