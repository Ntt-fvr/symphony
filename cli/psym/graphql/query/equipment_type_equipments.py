...
class EquipmentTypeEquipmentQuery:
    ...
    # fmt: off
    @classmethod
    def execute(cls, client: Client, id: str) -> Optional[EquipmentTypeEquipmentQueryData.Node]:
        variables: Dict[str, Any] = {"id": id}
        new_variables = encode_variables(variables, custom_scalars)
        response_text = client.execute(
            gql("".join(set(QUERY))), variable_values=new_variables
        )
        res = cls.EquipmentTypeEquipmentQueryData.from_dict(response_text)
        return res.equipmentType

    # fmt: off
    @classmethod
    async def execute_async(cls, client: Client, id: str) -> Optional[EquipmentTypeEquipmentQueryData.Node]:
        variables: Dict[str, Any] = {"id": id}
        new_variables = encode_variables(variables, custom_scalars)
