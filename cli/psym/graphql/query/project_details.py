...
class ProjectDetailsQuery:
    ...
    # fmt: off
    @classmethod
    def execute(cls, client: Client, id: str) -> Optional[ProjectDetailsQueryData.Node]:
    ...
    # fmt: off
    @classmethod
    async def execute_async(cls, client: Client, id: str) -> Optional[ProjectDetailsQueryData.Node]:
        variables: Dict[str, Any] = {"id": id}
        new_variables = encode_variables(variables, custom_scalars)
