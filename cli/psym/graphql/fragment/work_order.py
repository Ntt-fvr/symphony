...
class WorkOrderFragment(DataClassJsonMixin):
    ...
    status: WorkOrderStatus = field(metadata=enum_field_metadata(WorkOrderStatus))
    priority: WorkOrderPriority = field(metadata=enum_field_metadata(WorkOrderPriority))
