...
func HasCategoryFk() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(CategoryFkTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, CategoryFkTable, CategoryFkColumn),
		)
...
func HasCategoryFkWith(preds ...predicate.Kqi) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
