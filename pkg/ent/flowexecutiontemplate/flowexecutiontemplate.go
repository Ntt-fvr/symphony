...
const (
	// Label holds the string label denoting the flowexecutiontemplate type in the database.
	Label = "flow_execution_template"
	...
	// Table holds the table name of the flowexecutiontemplate in the database.
	Table = "flow_execution_templates"
	...
	BlocksColumn = "flow_execution_template_blocks"
)

// Columns holds all SQL columns for flowexecutiontemplate fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
