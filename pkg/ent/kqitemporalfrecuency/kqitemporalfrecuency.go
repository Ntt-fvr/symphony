...
const (
	// Label holds the string label denoting the kqitemporalfrecuency type in the database.
	Label = "kqi_temporal_frecuency"
	...
	// Table holds the table name of the kqitemporalfrecuency in the database.
	Table = "kqi_temporal_frecuencies"
	...
	// KqiTemporalFrecuencyFkInverseTable is the table name for the Kqi entity.
	// It exists in this package in order to avoid circular dependency with the "kqi" package.
	KqiTemporalFrecuencyFkInverseTable = "kqis"
...
// Columns holds all SQL columns for kqitemporalfrecuency fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
