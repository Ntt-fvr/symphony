...
const (
	// Label holds the string label denoting the resourcerelationshiptype type in the database.
	Label = "resource_relationship_type"
	...
	// Table holds the table name of the resourcerelationshiptype in the database.
	Table = "resource_relationship_types"
	...
	ResourceRelationshipFkColumn = "resource_relationship_type_resource_relationship_fk"
	...
	PoliciesColumn = "resource_relationship_type_policies"
)

// Columns holds all SQL columns for resourcerelationshiptype fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
