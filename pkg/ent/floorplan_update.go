...
func (fpu *FloorPlanUpdate) Where(ps ...predicate.FloorPlan) *FloorPlanUpdate {
	fpu.mutation.predicates = append(fpu.mutation.predicates, ps...)
	return fpu
}
...
func (fpu *FloorPlanUpdate) defaults() {
...
// defaults sets the default values of the builder before save.
func (fpuo *FloorPlanUpdateOne) defaults() {
...
func (fpuo *FloorPlanUpdateOne) sqlSave(ctx context.Context) (_node *FloorPlan, err error) {
	_spec := &sqlgraph.UpdateSpec{
		Node: &sqlgraph.NodeSpec{
			Table:   floorplan.Table,
			Columns: floorplan.Columns,
	...
	_node = &FloorPlan{config: fpuo.config}
