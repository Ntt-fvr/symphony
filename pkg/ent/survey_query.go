...
func (sq *SurveyQuery) FirstIDX(ctx context.Context) int {
...
func (sq *SurveyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if ps := sq.order; len(ps) > 0 {
		_spec.Order = func(selector *sql.Selector) {
			for i := range ps {
				ps[i](selector, survey.ValidColumn)
			}
		}
	}
	return _spec
...
func (sgb *SurveyGroupBy) sqlQuery() *sql.Selector {
	...
	for _, fn := range sgb.fns {
		columns = append(columns, fn(selector, survey.ValidColumn))
	}
