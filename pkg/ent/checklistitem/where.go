...
func IsMandatory(v bool) predicate.CheckListItem {
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func TypeEQ(v enum.CheckListItemType) predicate.CheckListItem {
	vc := v
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func TypeNEQ(v enum.CheckListItemType) predicate.CheckListItem {
	vc := v
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func TypeIn(vs ...enum.CheckListItemType) predicate.CheckListItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypeNotIn(vs ...enum.CheckListItemType) predicate.CheckListItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func IsMandatoryEQ(v bool) predicate.CheckListItem {
	return predicate.CheckListItem(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldIsMandatory), v))
	})
}
...
func IsMandatoryNEQ(v bool) predicate.CheckListItem {
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func IsMandatoryIsNil() predicate.CheckListItem {
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func IsMandatoryNotNil() predicate.CheckListItem {
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func EnumSelectionModeValueEQ(v enum.CheckListItemEnumSelectionMode) predicate.CheckListItem {
	vc := v
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func EnumSelectionModeValueNEQ(v enum.CheckListItemEnumSelectionMode) predicate.CheckListItem {
	vc := v
	return predicate.CheckListItem(func(s *sql.Selector) {
...
func EnumSelectionModeValueIn(vs ...enum.CheckListItemEnumSelectionMode) predicate.CheckListItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func EnumSelectionModeValueNotIn(vs ...enum.CheckListItemEnumSelectionMode) predicate.CheckListItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
