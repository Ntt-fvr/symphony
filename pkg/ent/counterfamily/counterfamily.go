...
const (
	// Label holds the string label denoting the counterfamily type in the database.
	Label = "counter_family"
...
// Columns holds all SQL columns for counterfamily fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
