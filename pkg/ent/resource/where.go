...
func Available(v bool) predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
...
func AvailableEQ(v bool) predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAvailable), v))
	})
}
...
func AvailableNEQ(v bool) predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
...
func AvailableIsNil() predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
...
func AvailableNotNil() predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldAvailable)))
	})
}

// HasResourcespec applies the HasEdge predicate on the "resourcespec" edge.
func HasResourcespec() predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ResourcespecTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, ResourcespecTable, ResourcespecColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasResourcespecWith applies the HasEdge predicate on the "resourcespec" edge with a given conditions (other predicates).
func HasResourcespecWith(preds ...predicate.ResourceSpecification) predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ResourcespecInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, ResourcespecTable, ResourcespecColumn),
		)
...
// HasResourceA applies the HasEdge predicate on the "resource_a" edge.
func HasResourceA() predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ResourceATable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ResourceATable, ResourceAColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasResourceAWith applies the HasEdge predicate on the "resource_a" edge with a given conditions (other predicates).
func HasResourceAWith(preds ...predicate.ResourceRelationship) predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasResourceB applies the HasEdge predicate on the "resource_b" edge.
func HasResourceB() predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ResourceBTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ResourceBTable, ResourceBColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasResourceBWith applies the HasEdge predicate on the "resource_b" edge with a given conditions (other predicates).
func HasResourceBWith(preds ...predicate.ResourceRelationship) predicate.Resource {
	return predicate.Resource(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
