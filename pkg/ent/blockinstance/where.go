...
func InputJSON(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldInputJSON), v))
	})
}

// OutputJSON applies equality check predicate on the "output_json" field. It's identical to OutputJSONEQ.
func OutputJSON(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldOutputJSON), v))
	})
}
...
func InputJSONEQ(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldInputJSON), v))
	})
}
...
func InputJSONNEQ(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldInputJSON), v))
	})
}

// InputJSONIn applies the In predicate on the "input_json" field.
func InputJSONIn(vs ...string) predicate.BlockInstance {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.BlockInstance(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldInputJSON), v...))
	})
}

// InputJSONNotIn applies the NotIn predicate on the "input_json" field.
func InputJSONNotIn(vs ...string) predicate.BlockInstance {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.BlockInstance(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldInputJSON), v...))
	})
}

// InputJSONGT applies the GT predicate on the "input_json" field.
func InputJSONGT(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldInputJSON), v))
	})
}

// InputJSONGTE applies the GTE predicate on the "input_json" field.
func InputJSONGTE(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldInputJSON), v))
	})
}

// InputJSONLT applies the LT predicate on the "input_json" field.
func InputJSONLT(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldInputJSON), v))
	})
}

// InputJSONLTE applies the LTE predicate on the "input_json" field.
func InputJSONLTE(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldInputJSON), v))
	})
}

// InputJSONContains applies the Contains predicate on the "input_json" field.
func InputJSONContains(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.Contains(s.C(FieldInputJSON), v))
	})
}

// InputJSONHasPrefix applies the HasPrefix predicate on the "input_json" field.
func InputJSONHasPrefix(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.HasPrefix(s.C(FieldInputJSON), v))
	})
}

// InputJSONHasSuffix applies the HasSuffix predicate on the "input_json" field.
func InputJSONHasSuffix(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.HasSuffix(s.C(FieldInputJSON), v))
	})
}

// InputJSONIsNil applies the IsNil predicate on the "input_json" field.
func InputJSONIsNil() predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldInputJSON)))
	})
}

// InputJSONNotNil applies the NotNil predicate on the "input_json" field.
func InputJSONNotNil() predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldInputJSON)))
	})
}

// InputJSONEqualFold applies the EqualFold predicate on the "input_json" field.
func InputJSONEqualFold(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.EqualFold(s.C(FieldInputJSON), v))
	})
}

// InputJSONContainsFold applies the ContainsFold predicate on the "input_json" field.
func InputJSONContainsFold(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.ContainsFold(s.C(FieldInputJSON), v))
	})
}

// OutputJSONEQ applies the EQ predicate on the "output_json" field.
func OutputJSONEQ(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldOutputJSON), v))
	})
}
...
func OutputJSONNEQ(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONIn applies the In predicate on the "output_json" field.
func OutputJSONIn(vs ...string) predicate.BlockInstance {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.BlockInstance(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldOutputJSON), v...))
	})
}

// OutputJSONNotIn applies the NotIn predicate on the "output_json" field.
func OutputJSONNotIn(vs ...string) predicate.BlockInstance {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.BlockInstance(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldOutputJSON), v...))
	})
}

// OutputJSONGT applies the GT predicate on the "output_json" field.
func OutputJSONGT(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONGTE applies the GTE predicate on the "output_json" field.
func OutputJSONGTE(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONLT applies the LT predicate on the "output_json" field.
func OutputJSONLT(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONLTE applies the LTE predicate on the "output_json" field.
func OutputJSONLTE(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONContains applies the Contains predicate on the "output_json" field.
func OutputJSONContains(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.Contains(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONHasPrefix applies the HasPrefix predicate on the "output_json" field.
func OutputJSONHasPrefix(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.HasPrefix(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONHasSuffix applies the HasSuffix predicate on the "output_json" field.
func OutputJSONHasSuffix(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.HasSuffix(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONIsNil applies the IsNil predicate on the "output_json" field.
func OutputJSONIsNil() predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldOutputJSON)))
	})
}

// OutputJSONNotNil applies the NotNil predicate on the "output_json" field.
func OutputJSONNotNil() predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldOutputJSON)))
	})
}

// OutputJSONEqualFold applies the EqualFold predicate on the "output_json" field.
func OutputJSONEqualFold(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.EqualFold(s.C(FieldOutputJSON), v))
	})
}

// OutputJSONContainsFold applies the ContainsFold predicate on the "output_json" field.
func OutputJSONContainsFold(v string) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		s.Where(sql.ContainsFold(s.C(FieldOutputJSON), v))
	})
}
...
// HasBlockActivities applies the HasEdge predicate on the "block_activities" edge.
func HasBlockActivities() predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(BlockActivitiesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, BlockActivitiesTable, BlockActivitiesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasBlockActivitiesWith applies the HasEdge predicate on the "block_activities" edge with a given conditions (other predicates).
func HasBlockActivitiesWith(preds ...predicate.AutomationActivity) predicate.BlockInstance {
	return predicate.BlockInstance(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(BlockActivitiesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, BlockActivitiesTable, BlockActivitiesColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
