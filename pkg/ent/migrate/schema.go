...
var (
	...
	BlocksColumns = []*schema.Column{
		...
		{Name: "input_transf_strategy", Type: field.TypeEnum, Enums: []string{"replace", "merge"}},
		...
		{Name: "output_transf_strategy", Type: field.TypeEnum, Enums: []string{"replace", "merge"}},
		...
		{Name: "input_state_transf_strategy", Type: field.TypeEnum, Enums: []string{"replace", "merge"}},
		...
		{Name: "output_state_transf_strategy", Type: field.TypeEnum, Enums: []string{"replace", "merge"}},
		...
		{Name: "retry_unit", Type: field.TypeEnum, Enums: []string{"seconds", "minutes", "hours"}},
		{Name: "max_attemps", Type: field.TypeInt, Nullable: true},
		{Name: "back_off_rate", Type: field.TypeInt, Nullable: true},
		{Name: "timer_behavior", Type: field.TypeEnum, Nullable: true, Enums: []string{"fixed_interval", "specific_time"}},
	...
	BlocksTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns: []*schema.Column{BlocksColumns[47]},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{BlocksColumns[3], BlocksColumns[49]},
			},
			{
				Name:    "block_cid_flow_blocks",
				Unique:  true,
				Columns: []*schema.Column{BlocksColumns[3], BlocksColumns[48]},
			},
			{
	...
	PermissionsPoliciesColumns = []*schema.Column{
		...
		{Name: "is_multicontractor", Type: field.TypeBool, Nullable: true},
	...
	// PropertyTypeValuesColumns holds the columns for the "property_type_values" table.
	PropertyTypeValuesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "create_time", Type: field.TypeTime},
		{Name: "update_time", Type: field.TypeTime},
		{Name: "name", Type: field.TypeString},
	...
	PropertyTypeValuesTable = &schema.Table{
		...
		Columns:    PropertyTypeValuesColumns,
	...
	ResourceTypesColumns = []*schema.Column{
		...
		{Name: "update_time", Type: field.TypeTime},
		{Name: "name", Type: field.TypeString, Unique: true},
		{Name: "resource_type_class", Type: field.TypeEnum, Enums: []string{"EQUIPMENT", "SLOT", "RACK", "PORT", "CARD", "VLAN", "NETWORK_FUNCTION"}},
...
func init() {
	...
	PropertyTypesTable.ForeignKeys[7].RefTable = PropertyTypesTable
