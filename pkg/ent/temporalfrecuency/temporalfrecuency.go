...
const (
	// Label holds the string label denoting the temporalfrecuency type in the database.
	Label = "temporal_frecuency"
...
// Columns holds all SQL columns for temporalfrecuency fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
