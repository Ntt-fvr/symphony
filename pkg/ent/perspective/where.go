...
func ID(id int) predicate.Perspective {
...
func IDEQ(id int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
...
func HasPerspectiveFk() predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(PerspectiveFkTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, PerspectiveFkTable, PerspectiveFkColumn),
		)
...
func HasPerspectiveFkWith(preds ...predicate.Kqi) predicate.Perspective {
	return predicate.Perspective(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
