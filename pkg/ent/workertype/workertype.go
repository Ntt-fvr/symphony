...
const (
	// Label holds the string label denoting the workertype type in the database.
	Label = "worker_type"
	...
	// Table holds the table name of the workertype in the database.
	Table = "worker_types"
	...
	PropertyTypesColumn = "worker_type_property_types"
)

// Columns holds all SQL columns for workertype fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
