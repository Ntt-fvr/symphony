...
func HasUserFk() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasUserFkWith(preds ...predicate.User) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkOrderFk() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(WorkOrderFkTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, WorkOrderFkTable, WorkOrderFkColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasWorkOrderFkWith applies the HasEdge predicate on the "work_order_fk" edge with a given conditions (other predicates).
func HasWorkOrderFkWith(preds ...predicate.WorkOrder) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(WorkOrderFkInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, WorkOrderFkTable, WorkOrderFkColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasPoliciesWith(preds ...predicate.PermissionsPolicy) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
