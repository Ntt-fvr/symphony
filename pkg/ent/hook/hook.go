...
// The PropertyTypeValueFunc type is an adapter to allow the use of ordinary
// function as PropertyTypeValue mutator.
type PropertyTypeValueFunc func(context.Context, *ent.PropertyTypeValueMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PropertyTypeValueFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
