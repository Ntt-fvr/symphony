...
var WoDataHeader = []string{bom + "Work Order ID", "Template", "Work Order Name", "Project Name", "Status", "Close Date", "Assignee", "Owner", "Priority", "Created date", "Target date", "Location"}
